	...
	return (
		<section title="navigation" className="hidden sm:flex fixed top-0 w-full px-4 justify-between backdrop-blur-lg z-10 items-center">
			...
			<div className="flex justify-end items-center gap-2">
				<Button variant="ghost">
					<a href="https://github.com/seannkelleyy" target="_blank" rel="noopener noreferrer" title="GitHub Profile">
						<Github />
					</a>
				</Button>
				<Button variant="ghost">
					<a href="https://www.linkedin.com/in/seankelley15/" target="_blank" rel="noopener noreferrer" title="LinkedIn Profile">
						<Linkedin />
					</a>
				</Button>
				<Button variant="ghost">
					<a href="mailto:seannkelleyy1@gmail.com" target="_blank" rel="noopener noreferrer" title="Email Me">
						<Mail />
					</a>
				</Button>
				<ThemeToggle />
